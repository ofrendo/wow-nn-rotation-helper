...
public class BasicCSVClassifier {
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            //layer0 has 15 params
            //layer1 has 12 params
            //layer2 has 12 params
            Layer layer1 = model.getLayer(1);
            System.out.println("Layer1" + layer1.params());
            System.out.println( layer1.paramTable());
